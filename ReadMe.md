...
useRouteMatch is a hook that matches the current URL without rendering a <Route>.

2. How would you explain form validation to someone who has never programmed before?

Form validation checks what a user inputs into a form when they press submit. It runs rules to verify if the data can be submitted.

3. In 1-2 sentences, define end to end testing.

End to end testing is testing that checks to see if the flow of an app from the beginning to the end is working as expected. It makes sure that all components and systems work together functionally.
